...
type Trace struct {
	...
	TraceAddress      string    `gorm:"column:trace_address" json:"trace_address"`
	...
	ArgumentNames     string    `gorm:"column:argument_names" json:"argument_names"`
	ArgumentTypes     string    `gorm:"column:argument_types" json:"argument_types"`
	ArgumentValues    string    `gorm:"column:argument_values" json:"argument_values"`
	OutputParameters  string    `gorm:"column:output_parameters" json:"output_parameters"`
	OutputNames       string    `gorm:"column:output_names" json:"output_names"`
	OutputTypes       string    `gorm:"column:output_types" json:"output_types"`
	OutputValues      string    `gorm:"column:output_values" json:"output_values"`
